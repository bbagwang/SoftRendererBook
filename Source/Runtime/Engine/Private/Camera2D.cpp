...
{
	return Matrix3x3
	(Vector3(_Transform.GetLocalX(), false), Vector3(_Transform.GetLocalY(), false), Vector3::UnitZ)
		* Matrix3x3(Vector3::UnitX, Vector3::UnitY, -Vector3(_Transform.GetWorldPosition()));
}
